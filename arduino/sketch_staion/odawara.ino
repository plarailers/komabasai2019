...
const unsigned long servo1_Siganl0 = 90;//サーボを動かす信号
const unsigned long servo1_Siganl1 = 50;
const unsigned long servo2_Siganl0 = D0;
const unsigned long servo2_Siganl1 = 30;
