#include <IRremote.h>
//地デジの7~11
const unsigned long channel_1 = 0x20DFDBEC;
const unsigned long channel_2 = 0x20DFDB1C;
const unsigned long channel_3 = 0x20DFDB9C;
const unsigned long channel_4 = 0x20DFDB5C;
const unsigned long channel_5 = 0x20DFDBDC;
